      ...
      <div className='grid gap-25 md:flex justify-between'>
        <div className='flex flex-row gap-3 max-w-[230px] md:flex-col'>
            <div>
                ...
                <h3 className='hidden md:block text-4xl md:text-lg text-center' style={{ fontFamily: "Wix Madefor Text sans-serif" }}>THE SAPIR DIFFERENCE </h3>
            </div>
        ...
        <div className='flex flex-row gap-3 max-w-[230px] md:flex-col '>
            <div className=''>
                ...
                <h3 className='hidden md:block text-4xl md:text-lg text-center' style={{ fontFamily: "Wix Madefor Text sans-serif" }}>THE PRODUCTS</h3>
            </div>
            <div>
        ...
        <div className='flex flex-row gap-3 max-w-[230px] md:flex-col'>
            <div>
                ...
                <h3 className='hidden md:block text-4xl md:text-lg text-center' style={{ fontFamily: "Wix Madefor Text sans-serif" }}>THE SPA </h3>
            </div>
            <div>
